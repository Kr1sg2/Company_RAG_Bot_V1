...
def _name(m): return m.get("file_name") or m.get("source") or m.get("doc_name") or "source"
def _page(m):
    ...
    def wrapped(*args, **kwargs):
        ...
        try:
            ...
            if isinstance(out, dict):
                ...
                prepend = f"Direct quote from {_name(meta)} (p.{_page(meta)}): \"{fact}\"\n\n"
